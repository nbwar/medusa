...
describe("cross-module-query", () => {
  ...
  describe("augmentFindOptionsWithCrossModuleJoins", () => {
    ...
    it("should nest anchored joins as correlated exists inside the parent join", () => {
      const result = augmentFindOptionsWithCrossModuleJoins(
        {
          where: {},
          options: {
    ...
    it("should combine parent target filters with nested anchored filters", () => {
      const result = augmentFindOptionsWithCrossModuleJoins(
        {
          where: {},
          options: {
    ...
    it("should support deeply nested anchor chains recursively", () => {
      const result = augmentFindOptionsWithCrossModuleJoins(
        {
          where: {},
          options: {
    ...
    it("should not emit a top-level exists for anchored-only joins", () => {
      const result = augmentFindOptionsWithCrossModuleJoins(
        {
          where: {},
          options: {
    ...
    it("should throw on unknown anchor references", () => {
      expect(() =>
        augmentFindOptionsWithCrossModuleJoins(
          {
            where: {},
